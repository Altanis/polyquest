...
this project will likely go unmaintained for a few months due to a loss of motiviation. also, the game is hosted on https://polyfight.xyz/polyquest/ if you want to play.
